...
export class Backend implements backendInterface {
    ...
    async getExternalIpAddress(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getExternalIpAddress();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getGeoInfo(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getGeoInfo();
    ...
    async measurePingLatency(): Promise<{
        latencyMs: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.measurePingLatency();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async testDownloadSpeed(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.testDownloadSpeed();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
